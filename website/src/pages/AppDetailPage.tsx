...
import { installedArt, installedArtList, classifyManifestArt } from '../components/appstore/useHeroArt'
      ...
      if (installed) {
        ...
        if (registryEntry && isBuiltinServerRow(registryEntry)) {
          ...
          setApp({
            ...
            iconUrl: registryEntry?.iconUrl || installedArt(m.iconPath, installed.name)
              || installedArt(m.iconUrl, installed.name) || pageIconUrl || '',
            iconUrlDark: registryEntry?.iconUrlDark || installedArt(m.iconPathDark, installed.name)
              || installedArt(m.iconUrlDark, installed.name) || '',
