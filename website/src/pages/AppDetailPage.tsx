                    ...
                    <div className="flex items-center gap-1.5 flex-wrap">
                      {contributors.slice(0, 6).map(c => (
                        <a
                          ...
                          title={c.name}
                          className="inline-flex items-center gap-1.5 rounded-full pl-0.5 pr-2 py-0.5 no-underline"
                          style={{ background: 'var(--bg-elevated)', border: '1px solid var(--border)', color: 'var(--text)' }}
                        >
                          <span
                            className="relative inline-flex h-[18px] w-[18px] items-center justify-center overflow-hidden rounded-full text-[9px]"
