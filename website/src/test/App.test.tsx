...
describe('App routing', () => {
  ...
  // A rejected lazy import must stay inside its route area, avoid exposing the
  // developer exception, and recover when the user retries the chunk fetch.
  it('recovers a lazy route after its first chunk load fails', async () => {
    ...
    try {
      ...
      expect(await screen.findByText("This page couldn't load. Check the connection to the gateway, then try again.")).toBeInTheDocument()
